...
\begin{equation}
    ...
    v_z = v \sin(\theta)
\end{equation}
where $\theta$ is the angle in the vertical plane and $\phi$ is the angle in the horizontal plane. The angles are computed based on the action index, which is a number between 0 and 26. 
