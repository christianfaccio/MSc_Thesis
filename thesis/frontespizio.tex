...
\newcommand*\Laureando[2][Candidate]{%
...
\newcommand\UNITSlogos{%
	...
	\begin{minipage}{\textwidth}%
		\centering
		\includegraphics[height=\logoheight]{assets/logoTS.png}%
		\hspace{40mm}
		\raisebox{3mm}{\includegraphics[height=\logoheight]{assets/logoUA.pdf}}%
	\end{minipage}%
	\par
}
