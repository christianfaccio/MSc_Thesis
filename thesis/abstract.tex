...
an unknown environment and find the target zones, outperforming a random policy. Moreover, the results
show that the use of independent agents lead to better performance overall, against the use of a centralized 
critic or communication at execution time. However, communication has been found to be useful when 
agents are deployed at the same position, and scaling the number of agents lead to higher coverage
and lower time to target.